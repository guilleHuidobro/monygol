...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link href="/~jarol/monygol/css/style.css" rel="stylesheet" type="text/css" />
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		   <link rel="icon" href="/~jarol/monygol/imagen/appiconoazul90.png" type="image/x-icon" />
		<title>MonyGol</title>	
...
<div class="navbar navbar-custom navbar-static-top">
  <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="#"> <img src="/~jarol/monygol/imagen/app_logo.png" alt="Balon de Oro" height="50px" width="150px" 
            ...
            <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" name="loginform" id="loginform" method="post" action="accionregistro.php" onsubmit="return validateForm()">
                            ...
                            <div class="form-group">
                                <input type="text" name="fono" id="fono" class="form-control input-sm" placeholder="telefono">
                            </div>
