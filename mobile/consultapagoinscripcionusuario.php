...
$sql ="SELECT * FROM `registro_pago_usuarios` WHERE `usuario` = '$usuario'";
...
if (!$resultado = $mysqli->query($sql)) {
    ...
    $pagoinscripcionusuario = [
    "consultapagoinscripcionusuario" => $emparray
];    
    echo json_encode($pagoinscripcionusuario). "\n";
